...
## Warden → Lance   (kills in 4 round(s))
...
## Lance → Warden   (kills in 2 round(s))
...
start     [ ][ ][ ][ ][ ]
round 1
  action 1  pierce-5 ×2 = damage-10   acc 0+10=10 / toughness-6  FLIP (waste-4)   [#][ ][ ][ ][ ]
  action 2  pierce-5 ×2 = damage-10   acc 0+10=10 / toughness-6  FLIP (waste-4)   [#][#][ ][ ][ ]
  action 3  pierce-5 ×2 = damage-10   acc 0+10=10 / toughness-6  FLIP (waste-4)   [#][#][#][ ][ ]
  -- end round 1: acc clear
round 2
  action 1  pierce-5 ×2 = damage-10   acc 0+10=10 / toughness-6  FLIP (waste-4)   [#][#][#][#][ ]
  action 2  pierce-5 ×2 = damage-10   acc 0+10=10 / toughness-6  FLIP (waste-4)   [#][#][#][#][#]
