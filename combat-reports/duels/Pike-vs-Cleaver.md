...
## Pike → Cleaver   (kills in 3 round(s))
...
start     [ ][ ][ ]
round 1
  action 1  pierce might-8 − resist-0 = damage-8   acc 0+8=8 / toughness-4  FLIP (waste-4)   [#][ ][ ]
...
## Cleaver → Pike   (kills in 3 round(s))
...
start     [ ][ ][ ]
round 1
  action 1  slash might-8 − resist-3 = damage-5   acc 0+5=5 / toughness-4  FLIP (waste-1)   [#][ ][ ]
  -- end round 1: acc clear
round 2
  action 1  slash might-8 − resist-3 = damage-5   acc 0+5=5 / toughness-4  FLIP (waste-1)   [#][#][ ]
  -- end round 2: acc clear
