...
| `run-fresh`        | Run the game from a clean slate: delete the persisted save first (what "Start Over" does), so it opens the pristine table. Leaves any `.bak` backups alone.                                         |
