...
reaches the *capacity to act* (see [the four aspects](decks-and-aspects.md#the-four-aspects)).
...
Resolve is a stat like any other: a stack of plain **Resolve cards** in Form plus a
**rules card** (see [form & defeat](form-and-defeat.md#how-damage-resolves)). **Fear**
is its damage type, and it **accumulates within a round, not between** — a steady
nerve recovers each round, a sustained terror wears you down inside one. Composure and
resolve are the **only** shield against the inner aspects; armor does nothing.

When fear in a round **overcomes** your Resolve, it breaks through to your own panic:
you **freeze, flee, or — in the extreme — are scared to death** (your body's response
flipping *Body* cards). A **Resolute** character shrugs it; a **Coward** crumbles.
...
**Collective** (live in the [party zone](zones.md#beyond-the-four--shared-zones)):
