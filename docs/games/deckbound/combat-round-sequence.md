...
| --- | -------------------- | --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 1   | **Havoc**            | O->R, RV->O     | Point-blank: every prior-round outrider strikes the enemy **rearguard** it crossed to reach (the vanguard it slipped past is the front-trade steps' business) and takes fire from its hosts in return - no screen, mutual; a sweep catches that rearguard tier. A kill here opens a hole before anything else runs. Afterwards an outrider whose host formation is wiped **dissolves** back to its own line. |
