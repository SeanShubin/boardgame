...
- **Trade** — A same-range melee sub-phase: both sides deal their base through toughness. In the optional Clash module, the trade becomes the four-card mix-up.
