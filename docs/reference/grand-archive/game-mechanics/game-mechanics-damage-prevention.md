> For the complete documentation index, see [llms.txt](https://rules.gatcg.com/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://rules.gatcg.com/game-mechanics/game-mechanics-damage-prevention.md).
...
3. Damage prevention will follow the order of determining replacement effects as described under [Replacement Effects](/game-mechanics/game-mechanics-types-of-effects/types-of-effects-replacement-effects.md).
