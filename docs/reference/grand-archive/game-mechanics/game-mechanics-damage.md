> For the complete documentation index, see [llms.txt](https://rules.gatcg.com/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://rules.gatcg.com/game-mechanics/game-mechanics-damage.md).
...
{% hint style="danger" %} <img src="/files/GlH3npuPgHpcxWfdjHG6" alt="" data-size="original"><img src="/files/ZKB8MSkwCVx7ErwDY3C8" alt="" data-size="original">\
\
