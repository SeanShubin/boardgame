> For the complete documentation index, see [llms.txt](https://rules.gatcg.com/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://rules.gatcg.com/game-mechanics/game-mechanics-miscellaneous-topics/special-game-actions-and-turn-based-actions.md).
...
{% hint style="warning" %} <img src="https://ga-index-public.s3.us-west-2.amazonaws.com/cards/eternal-magistrate-mrc.jpg" alt="" data-size="original">
