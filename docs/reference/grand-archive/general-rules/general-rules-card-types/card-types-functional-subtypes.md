> For the complete documentation index, see [llms.txt](https://rules.gatcg.com/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://rules.gatcg.com/general-rules/general-rules-card-types/card-types-functional-subtypes.md).
...
1. Siegeable
   1. "Siegeable" is a subtype modifier for domains that allows them to be declared as attack targets.
      ...
      2. Cards that target a unit will not be able to target a Siegeable domain unless it is a type of unit in addition to its other types.
