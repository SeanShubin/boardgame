> For the complete documentation index, see [llms.txt](https://rules.gatcg.com/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://rules.gatcg.com/general-rules/general-rules-card-types/card-types-supertypes.md).
...
{% hint style="info" %}
&#x20;See [Type Changing](/general-rules/general-rules-card-characteristics.md#changing-characteristics-type-overwriting-and-type-setting)
{% endhint %}
