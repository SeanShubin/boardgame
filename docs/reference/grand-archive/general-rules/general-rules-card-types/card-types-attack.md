> For the complete documentation index, see [llms.txt](https://rules.gatcg.com/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://rules.gatcg.com/general-rules/general-rules-card-types/card-types-attack.md).
...
8. Attack cards will go to the graveyard from the intent during the End of Combat step of the [Combat Phase](/game-mechanics/game-mechanics-turn-order/turn-order-combat-phase.md).
