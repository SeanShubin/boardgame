> For the complete documentation index, see [llms.txt](https://rules.gatcg.com/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://rules.gatcg.com/general-rules/general-rules-card-characteristics/double-faced-cards.md).
...
\ <img src="/files/OhSWWuB0XKIe1MrOOS3C" alt="" data-size="original"><img src="/files/3Dj9DhWYlBfHbi8eewSL" alt="" data-size="original"><br>
{% endhint %}
...
{% hint style="danger" %} <img src="/files/kX9jPuKbrPBhsDAQ11hb" alt="" data-size="original"><img src="/files/du0i3Mr3zq8oPk9dl71f" alt="" data-size="original">\
\
