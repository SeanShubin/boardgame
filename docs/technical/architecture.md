...
A game implements [`engine::Game`](../../crates/engine/src/game.rs) over its own
...
[`TableView`](../../crates/engine/src/view.rs): a plain description of the zones
...
- [`PlayerId`](../../crates/engine/src/player.rs) — a seat index.
- [`view`](../../crates/engine/src/view.rs) — `TableView`, `ZoneView`,
